...
DATA = 'Data'
CORPUS = 'Data/CORPUS'
LDAMODEL = 'Data/MODEL/LDAmodel'
VECTORIZEMODEL = 'Data/MODEL/VectorizeModel'
TFIDF = 'Data/TFIDF'
KDTREE = 'Data/KDTree'
MAINCORPUS = 'Data/preprocessed_copus.csv'
...
def mainHandler(text, topic = 5, value_range = 5, record = 10):
  ...
  return output_df.to_json(orient = 'records', lines = True)
...
# Port 3000/HS_request
# POST method, Json format {'description': String}
# response: {
#   'predict': {
#       'label_name': Float     *8 different label
#   },
#   'summarize': [String, String, String, ....]
# }


@app.route('/HS_request', methods = ['POST'])
def worker():
    ...
    return mainHandler(description, 5, 5)
